...
import fallbackOne from "../assets/storyimage/9.jpg";
import fallbackTwo from "../assets/storyimage/10.jpg";
import fallbackThree from "../assets/storyimage/4.jpg";
import fallbackFour from "../assets/storyimage/5.jpg";
...
const FALLBACK_POSTS = [
  {
    id: "fallback-1",
    mediaType: "IMAGE",
    mediaUrl: fallbackOne,
    permalink: INSTAGRAM_PROFILE_URL,
    caption: "Everyday fits, made the Filo Teso way.",
  },
  {
    id: "fallback-2",
    mediaType: "IMAGE",
    mediaUrl: fallbackTwo,
    permalink: INSTAGRAM_PROFILE_URL,
    caption: "New drops and styling inspiration.",
  },
  {
    id: "fallback-3",
    mediaType: "IMAGE",
    mediaUrl: fallbackThree,
    permalink: INSTAGRAM_PROFILE_URL,
    caption: "Behind the scenes at Filo Teso.",
  },
  {
    id: "fallback-4",
    mediaType: "IMAGE",
    mediaUrl: fallbackFour,
    permalink: INSTAGRAM_PROFILE_URL,
    caption: "Premium streetwear for every mood.",
  },
];
